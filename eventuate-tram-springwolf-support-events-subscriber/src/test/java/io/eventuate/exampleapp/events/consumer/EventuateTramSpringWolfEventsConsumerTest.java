...
public class EventuateTramSpringWolfEventsConsumerTest {
  ...
  @Import({TramInMemoryConfiguration.class, EventuateSpringWolfConfiguration.class, EventuateSpringWolfEventsSubscriberConfiguration.class, CustomerEventConsumerConfiguration.class})
